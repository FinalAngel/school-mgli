...
\subsubsection{Weiters zum Kartesischen Produkt}

\begin{itemize}
  \item Es kann aus unterschiedlicher Grundmenge viele nicht-triviale neue Mengen bilden.
  \item Hat etwas andere rechnerische Eigenschaften.
  \item Wichtig bei der Bildung von Relation und Funktion.
  \item Erlauft den Begriff der Paarung und damit den Vergleich der Mächtigkeiten, auch von unendlichen Mengen.
\end{itemize}
